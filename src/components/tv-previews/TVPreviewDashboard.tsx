...
export default function TVPreviewDashboard({ uploadedImage, onImageUpload }: TVPreviewDashboardProps) {
        ...
        <>
          <div className="bg-tv-gray/50 border border-tv-red/30 rounded-lg p-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="text-lg font-bold text-tv-red mb-2">Issues Detected</h3>
                <ul className="space-y-2 text-gray-300">
                  <li>• Text may be too small on Roku and Fire TV interfaces</li>
                  <li>• Important content hidden by Samsung TV progress bar</li>
                  <li>• Consider moving key elements away from bottom 20%</li>
                </ul>
              </div>
            </div>
          </div>
